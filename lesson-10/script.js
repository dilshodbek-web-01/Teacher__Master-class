...
$('.btn-success').addEventListener('click', () => {
    $('.card').classList.add('rounded-5', 'border-5', 'p-5', "text-danger");
});
...
for (let i = 0; i < user.length; i++) {
    ...
    div.innerHTML = `<img src="${user[i].avatar}" alt="img" width="100" class="rounded-circle"> <p> <strong>${user[i].id}</strong> ${user[i].first_name} ${user[i].last_name} </p> <h6>${user[i].email}</h6>` ;
